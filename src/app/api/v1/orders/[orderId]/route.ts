...
/**
 * GET /api/v1/orders/{orderId} - 特定の注文の詳細を取得する
 */
...
/**
 * PUT /api/v1/orders/{orderId} - 特定の注文全体を完全更新する
 */
...
/**
 * PATCH /api/v1/orders/{orderId} - 特定の注文データの一部のみを部分更新する
 */
...
/**
 * DELETE /api/v1/orders/{orderId} - 特定の注文を削除する
 */
